...
function PropertiesContent() {
  ...
  const [dealType, setDealType] = useState<string>(typeParam || '');
  ...
  const handleDealTypeChange = (t: string) => {
    setDealType(t);
    syncFilters({ type: t === '' ? null : t });
  };
  ...
  }, [dealType, location, selectedTypes, bedrooms, bathrooms, minPrice, maxPrice]);
              ...
              <label key={t.id} className="flex items-center gap-3 cursor-pointer group">
                <div className="relative flex items-center justify-center">
                  <input
                    ...
                    onChange={() => handleDealTypeChange(t.id)}
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
              <div>
                <div className="flex items-center gap-2 text-xs font-bold text-[#845326] uppercase tracking-[0.2em] mb-3">
                  ...
                  {location || locationParam ? `Discovery / ${location || locationParam}` : 'Mozambique'}
                </div>
                <h1
                  className="text-4xl font-extrabold text-[#002045] tracking-tighter"
                  style={{ fontFamily: 'var(--font-headline)' }}
                >
                  {location || locationParam ? `Estates in ${location || locationParam}` : `Property Inventory`}
                </h1>
