/// ISRG Root X1 — Let's Encrypt's root CA (public certificate, not a secret).
/// Bundled because some older Android versions (< 7.1 / API 25) never received
/// this root in their OS trust store, and the legacy cross-sign path via
/// "DST Root CA X3" that used to cover them expired in September 2021. Without
/// this, HTTPS requests to any Let's Encrypt-secured host fail on those devices
/// even though the certificate itself is perfectly valid.
const isrgRootX1Pem = '''
-----BEGIN CERTIFICATE-----
